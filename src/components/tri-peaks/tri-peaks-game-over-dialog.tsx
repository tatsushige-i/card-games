...
import type { TriPeaksGameResult } from "@/types/tri-peaks";

type TriPeaksGameOverDialogProps = {
  open: boolean;
...
/** ゲーム終了ダイアログ */
export function TriPeaksGameOverDialog({
  open,
  result,
  score,
  removedCount,
  ...
  return (
    ...
    >
      <DialogContent
        ...
        aria-describedby="tri-peaks-game-over-description"
      >
        <DialogHeader>
          <DialogTitle className="text-center text-2xl">{title}</DialogTitle>
          <DialogDescription
            id="tri-peaks-game-over-description"
